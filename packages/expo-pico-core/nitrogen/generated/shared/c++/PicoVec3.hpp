...
namespace margelo::nitro::expopico::picocore {
  ...
  /**
   * A struct which can be represented as a JavaScript object (PicoVec3).
   */
  struct PicoVec3 final {
  public:
  ...
  public:
    PicoVec3() = default;
    explicit PicoVec3(double x, double y, double z): x(x), y(y), z(z) {}

  public:
    friend bool operator==(const PicoVec3& lhs, const PicoVec3& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ PicoVec3 <> JS PicoVec3 (object)
  template <>
  struct JSIConverter<margelo::nitro::expopico::picocore::PicoVec3> final {
    static inline margelo::nitro::expopico::picocore::PicoVec3 fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::expopico::picocore::PicoVec3(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::expopico::picocore::PicoVec3& arg) {
