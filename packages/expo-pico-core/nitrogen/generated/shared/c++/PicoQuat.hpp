...
namespace margelo::nitro::expopico::picocore {
  ...
  /**
   * A struct which can be represented as a JavaScript object (PicoQuat).
   */
  struct PicoQuat final {
  public:
  ...
  public:
    PicoQuat() = default;
    explicit PicoQuat(double x, double y, double z, double w): x(x), y(y), z(z), w(w) {}

  public:
    friend bool operator==(const PicoQuat& lhs, const PicoQuat& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ PicoQuat <> JS PicoQuat (object)
  template <>
  struct JSIConverter<margelo::nitro::expopico::picocore::PicoQuat> final {
    static inline margelo::nitro::expopico::picocore::PicoQuat fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::expopico::picocore::PicoQuat(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::expopico::picocore::PicoQuat& arg) {
