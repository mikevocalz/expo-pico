...
namespace margelo::nitro::expopico::spatial {
  ...
  /**
   * A struct which can be represented as a JavaScript object (SpatialVec3).
   */
  struct SpatialVec3 final {
  public:
  ...
  public:
    SpatialVec3() = default;
    explicit SpatialVec3(double x, double y, double z): x(x), y(y), z(z) {}

  public:
    friend bool operator==(const SpatialVec3& lhs, const SpatialVec3& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ SpatialVec3 <> JS SpatialVec3 (object)
  template <>
  struct JSIConverter<margelo::nitro::expopico::spatial::SpatialVec3> final {
    static inline margelo::nitro::expopico::spatial::SpatialVec3 fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::expopico::spatial::SpatialVec3(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::expopico::spatial::SpatialVec3& arg) {
